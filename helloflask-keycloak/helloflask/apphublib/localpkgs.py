...
def local_packages(pkgs, basefile):
    ...
    Usage:
        ...
        2. wrap the list of packages in setup(..., install_requires=[...]) as
           follows:
        ...
        For downloading packages:
            ...
            $ pip download --platform manylinux1_x86_64 --only-binary=:all: \
              --no-binary=:none: -d ./packages .

            This downloads all packages given in install_requires, including
            dependencies in the format required by the omega-ml runtime
